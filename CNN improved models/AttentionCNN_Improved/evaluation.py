#!/usr/bin/env python3
"""
AttentionCNN_Improved - Evaluation Module
==============================================

Evaluation functionality for AttentionCNN_Improved model.
...
class AttentionCNNEvaluator:
    """Model evaluator for AttentionCNN_Improved"""
    ...
    def __init__(self, output_dir="attentioncnn_improved_results"):
        ...
        print(f"📊 AttentionCNN_Improved ModelEvaluator initialized")
        print(f"📁 Results will be saved to: {self.output_dir}")
    
    def evaluate_model(self, model, X_test, y_test, model_name="AttentionCNN_Improved", dataset_size=750):
    ...
    def plot_learning_curves(self, training_data, model_name="AttentionCNN_Improved", dataset_size=750):
    ...
    def save_results(self, model_name="AttentionCNN_Improved", dataset_size=750, format='all'):
