#!/usr/bin/env python3
"""
HybridCNN_Improved - Evaluation Module
===========================================

Evaluation functionality for HybridCNN_Improved model.
...
class HybridCNNEvaluator:
    """Model evaluator for HybridCNN_Improved"""
    ...
    def __init__(self, output_dir="hybridcnn_improved_results"):
        ...
        print(f"📊 HybridCNN_Improved ModelEvaluator initialized")
        print(f"📁 Results will be saved to: {self.output_dir}")
    
    def evaluate_model(self, model, X_test, y_test, model_name="HybridCNN_Improved", dataset_size=750):
    ...
    def plot_learning_curves(self, training_data, model_name="HybridCNN_Improved", dataset_size=750):
    ...
    def save_results(self, model_name="HybridCNN_Improved", dataset_size=750, format='all'):
