#!/usr/bin/env python3
"""
MultiScaleCNN_- Evaluation Module

Evaluation functionality for MultiScaleCNN_model.
MultiScaleCNN with 
"""
...
class MultiScaleCNNEvaluator:
    ...
    def __init__(self, output_dir="multiscalecnn_improved_results"):
        ...
        print(f" MultiScaleCNN_ModelEvaluator initialized")
