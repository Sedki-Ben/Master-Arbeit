#!/usr/bin/env python3
"""
MultiScaleCNN_Improved - Evaluation Module
===============================================

Evaluation functionality for MultiScaleCNN_Improved model.
...
class MultiScaleCNNEvaluator:
    """Model evaluator for MultiScaleCNN_Improved"""
    ...
    def __init__(self, output_dir="multiscalecnn_improved_results"):
        ...
        print(f"📊 MultiScaleCNN_Improved ModelEvaluator initialized")
        print(f"📁 Results will be saved to: {self.output_dir}")
    
    def evaluate_model(self, model, X_test, y_test, model_name="MultiScaleCNN_Improved", dataset_size=750):
    ...
    def plot_learning_curves(self, training_data, model_name="MultiScaleCNN_Improved", dataset_size=750):
    ...
    def save_results(self, model_name="MultiScaleCNN_Improved", dataset_size=750, format='all'):
