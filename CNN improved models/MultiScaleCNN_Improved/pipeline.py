#!/usr/bin/env python3
"""
MultiScaleCNN_- Pipeline Orchestrator

Orchestrates the complete MultiScaleCNN_training and evaluation pipeline.
MultiScaleCNN with 
"""
...
class MultiScaleCNN_ImprovedPipeline:
    """MultiScaleCNN_ImprovedPipeline."""
    ...
    def run_complete_pipeline(self, dataset_sizes=[250, 500, 750]):
        ...
        print(f"\n MultiScaleCNN_Pipeline Finished!")
