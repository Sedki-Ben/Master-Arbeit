...
Main script to run ResidualCNN_model training and evaluation.
ResidualCNN with 
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='ResidualCNN_Indoor Localization Model')
    ...
    print(" ResidualCNN_Indoor Localization Model")
    print("=" * 45)
