#!/usr/bin/env python3
"""
ResidualCNN_Improved - Main Entry Point
=============================================

Main script to run ResidualCNN_Improved model training and evaluation.
...
from pipeline import ResidualCNN_ImprovedPipeline

def main():
    """Main function"""
    
    parser = argparse.ArgumentParser(description='ResidualCNN_Improved Indoor Localization Model')
    parser.add_argument('--dataset-sizes', nargs='+', type=int, default=[250, 500, 750],
                       help='Dataset sizes to process (default: 250 500 750)')
    parser.add_argument('--output-dir', type=str, default='residualcnn_improved_results',
    ...
    print("🎯 ResidualCNN_Improved Indoor Localization Model")
    print("=" * 45)
    print(f"Output directory: {args.output_dir}")
    
    # Initialize pipeline
    pipeline = ResidualCNN_ImprovedPipeline(output_dir=args.output_dir)
