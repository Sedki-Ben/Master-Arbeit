...
from pipeline import BasicCNNOriginalPipeline

def main():
    """Main function"""
    
    parser = argparse.ArgumentParser(description='BasicCNN Original Indoor Localization Model')
    parser.add_argument('--dataset-sizes', nargs='+', type=int, default=[250, 500, 750],
                       help='Dataset sizes to process (default: 250 500 750)')
    parser.add_argument('--output-dir', type=str, default='basic_cnn_original_results',
