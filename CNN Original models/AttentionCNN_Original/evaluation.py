#!/usr/bin/env python3
"""
AttentionCNN_Original - Evaluation Module
==============================================

Evaluation functionality for AttentionCNN_Original model.
...
class AttentionCNNEvaluator:
    """Model evaluator for AttentionCNN_Original"""
    ...
    def __init__(self, output_dir="attentioncnn_original_results"):
        ...
        print(f"📊 AttentionCNN_Original ModelEvaluator initialized")
        print(f"📁 Results will be saved to: {self.output_dir}")
    
    def evaluate_model(self, model, X_test, y_test, model_name="AttentionCNN_Original", dataset_size=750):
    ...
    def plot_learning_curves(self, training_data, model_name="AttentionCNN_Original", dataset_size=750):
    ...
    def save_results(self, model_name="AttentionCNN_Original", dataset_size=750, format='all'):
