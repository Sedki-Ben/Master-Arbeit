...
class AttentionCNN_OriginalPipeline:
    ...
    def run_complete_pipeline(self, dataset_sizes=[250, 500, 750]):
        ...
        print(f"\n AttentionCNN_Original Pipeline Finished!")
