...
class MultiScaleCNNEvaluator:
    """Model evaluator for MultiScaleCNN_Original"""
    ...
    def __init__(self, output_dir="multiscalecnn_original_results"):
        ...
        print(f"📊 MultiScaleCNN_Original ModelEvaluator initialized")
        print(f"📁 Results will be saved to: {self.output_dir}")
    
    def evaluate_model(self, model, X_test, y_test, model_name="MultiScaleCNN_Original", dataset_size=750):
    ...
    def plot_learning_curves(self, training_data, model_name="MultiScaleCNN_Original", dataset_size=750):
    ...
    def save_results(self, model_name="MultiScaleCNN_Original", dataset_size=750, format='all'):
